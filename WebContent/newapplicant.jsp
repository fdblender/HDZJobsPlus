		...
		<div class="row">
			...
			<div class="col-sm-10">
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<fieldset>
							Institution: <input type="text" name="edu1" id="edu1" /> Degree: 
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<fieldset>
							...
							<br /> Start date: <input type="text" name="start2" id="start2" />
							End date: <input type="text" name="leave2" id="leave2" /> <br />
							<br /> Job title: <input type="text" name="job3" id="job3" />
				...
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<fieldset>
							...
							Phone: <input type="text" name="refphone1"
								id="refphone1" /><br /> Email: <input type="text"
								name="refemail1" id="refemail1" /> Position: <input
								type="text" name="refpos1" id="refpos1" /><br /> <br />
							Name: <input type="text" name="refname2" id="refname2" />
							Phone: <input type="text" name="refphone2"
								id="refphone2" /><br /> Email: <input type="text"
								name="refemail2" id="refemail2" /> Position: <input
								type="text" name="refpos2" id="refpos2" /><br /> <br />
							Name: <input type="text" name="refname3" id="refname3" />
							Phone: <input type="text" name="refphone3"
								id="refphone3" /><br /> Email: <input type="text"
								name="refemail3" id="refemail3" /> Position: <input
								type="text" name="refpos3" id="refpos3" /><br />
						</fieldset>
					</div>
				</div>
				<p id="invalid"></p>
