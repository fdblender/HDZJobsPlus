...
<div class="jumbotron text-center">
 ...
 <form class="form-inline" onsubmit="return validateLogin()"
    ...
    <br/><br/>
    <select id="loginrole" name="loginrole" style="width: 320px;color: gray;">
...
<div id="portfolio" class="container-fluid text-center bg-grey">
  <h2>Office Space</h2><br>
  <h4>Where we work</h4>
  <div class="row text-center slideanim">
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="images/office1.jpeg" alt="Paris" width="400" height="300">
    ...
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="images/office2.jpeg" alt="New York" width="400" height="300">
    ...
    <div class="col-sm-4">
      <div class="thumbnail">
        <img src="images/office3.jpeg" alt="San Francisco" width="400" height="300">
...
<div id="contact" class="container-fluid bg-grey">
  ...
  <div class="row">
    <div class="col-sm-5">
      ...
      <p><span class="glyphicon glyphicon-map-marker"></span> Montgomery, US</p>
      <p><span class="glyphicon glyphicon-phone"></span> +00 1515151515</p>
      <p><span class="glyphicon glyphicon-envelope"></span> study.javaclass@gmail.com</p>
    </div>
...
<footer class="container-fluid text-center">
  ...
  <p>HDZ <a href="http://localhost:8080/HDZJobs/" title="HDZ Careers">HDZ Careers</a></p>
</footer>
