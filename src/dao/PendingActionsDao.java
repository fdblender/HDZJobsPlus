...
public class PendingActionsDao {
	...
	public static boolean checkAppStatus(HdzApplication myapplication)
	{
		...
		List<HdzReftable> references=dao.PendingActionsDao.getRefbyapplicantid(myapplication.getHdzApplicant().getApplicantid());
		...
		List<HdzJobhistory> jobs=dao.PendingActionsDao.getjobhistorybyapplicantid(myapplication.getHdzApplicant().getApplicantid());
